...
describe 'Conversation', ->
  ...
  describe 'is_with_bot', ->
    it 'detects bot conversations by the email of the remote participant', ->
      ...
      user_et.email 'anna+123@YAA.com'
      conversation_et.type z.conversation.ConversationType.SELF
      ...
      user_et.email 'anne@YAA.com'
      expect(conversation_et.is_with_bot()).toBe false

      user_et.email 'anna+123@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'anna+quiz@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'welcome@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'welcome+123@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'welcome+chef@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'welcome+@@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'ottobot@YAA.com'
      expect(conversation_et.is_with_bot()).toBe true

      user_et.email 'hello@YAA.com'
      expect(conversation_et.is_with_bot()).toBe false
