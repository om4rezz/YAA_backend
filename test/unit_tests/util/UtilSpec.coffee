...
describe 'z.util.render_message', ->
  it 'renders a normal link', ->
    actual = z.util.render_message 'Check this: http://www.YAA.com/'
    expected = 'Check this: <a href="http://www.YAA.com/" target="_blank" rel="nofollow noopener noreferrer">http://www.YAA.com/</a>'
    expect(actual).toBe expected

  it 'renders a normal link without protocol', ->
    actual = z.util.render_message 'Check this: YAA.com/about/'
    expected = 'Check this: <a href="http://YAA.com/about/" target="_blank" rel="nofollow noopener noreferrer">YAA.com/about/</a>'
    expect(actual).toBe expected
  ...
  it 'renders an email address', ->
    actual = z.util.render_message "send it over to hello@YAA.com"
    expected = 'send it over to <a href="mailto:hello@YAA.com">hello@YAA.com</a>'
    expect(actual).toBe expected

  it 'renders an email address with pluses', ->
    actual = z.util.render_message "send it over to hello+world@YAA.com"
    expected = 'send it over to <a href="mailto:hello+world@YAA.com">hello+world@YAA.com</a>'
    expect(actual).toBe expected
...
describe 'Markdown for code snippets', ->
  ...
  it 'renders escaped HTML code blocks', ->
    code = "```html\n<a href=\"javascript:YAA.app.logout()\">This is a trick</a>\n```"
    actual = z.util.render_message code
    expected = "<pre><code class=\"lang-html\">&lt;<span class=\"hljs-tag\">a</span> href=<span class=\"hljs-string\">\"javascript:YAA.app.logout()\"</span>&gt;This is <span class=\"hljs-tag\">a</span> trick&lt;/a&gt;<br /></code></pre>"
    expect(actual).toEqual expected

  it 'renders escaped HTML code spans', ->
    code = "`<a href=\"javascript:YAA.app.logout()\">This is a trick</a>`"
    actual = z.util.render_message code
    expected = "<code>&lt;a href=&quot;javascript:YAA.app.logout()&quot;&gt;This is a trick&lt;/a&gt;</code>"
    expect(actual).toEqual expected
...
describe 'z.util.is_same_location', ->
  it 'returns false if page was accessed directly', ->
    actual = z.util.is_same_location '', 'https://app.YAA.com'
    expect(actual).toBeFalsy()

  it 'returns false if page was accessed from https://YAA.com', ->
    actual = z.util.is_same_location 'https://YAA.com', 'https://app.YAA.com'
    expect(actual).toBeFalsy()

  it 'returns false if page was accessed from https://YAA.com/download', ->
    actual = z.util.is_same_location 'https://YAA.com/download', 'https://app.YAA.com'
    expect(actual).toBeFalsy()

  it 'returns false if page was accessed from https://get.YAA.com', ->
    actual = z.util.is_same_location 'https://get.YAA.com', 'https://app.YAA.com'
    expect(actual).toBeFalsy()

  it 'returns false if page was accessed from an external link', ->
    actual = z.util.is_same_location 'http://www.heise.de', 'https://app.YAA.com'
    expect(actual).toBeFalsy()

  it 'returns false if redirected from auth', ->
    actual = z.util.is_same_location 'https://app.YAA.com/auth', 'https://app.YAA.com'
    expect(actual).toBeFalsy()

  it 'returns false if redirected from auth with parameter', ->
    actual = z.util.is_same_location 'https://app.YAA.com/auth/?env=staging', 'https://app.YAA.com/?env=staging'
    expect(actual).toBeFalsy()

  it 'returns false if redirected from auth with history hashtag', ->
    actual = z.util.is_same_location 'https://app.YAA.com/auth/#history', 'https://app.YAA.com/?env=staging'
    expect(actual).toBeFalsy()

  it 'returns false if redirected from auth with login hashtag', ->
    actual = z.util.is_same_location 'https://app.YAA.com/auth/?env=staging#login', 'https://app.YAA.com/?env=staging'
    expect(actual).toBeFalsy()

  it 'returns false if redirected from auth with registration hashtag', ->
    actual = z.util.is_same_location 'https://app.YAA.com/auth/?env=staging#register', 'https://app.YAA.com/?env=staging'
    expect(actual).toBeFalsy()

  it 'returns true if auth with login hashtag was reloaded', ->
    actual = z.util.is_same_location 'https://app.YAA.com/auth/#register', 'https://app.YAA.com/auth/'
    expect(actual).toBeFalsy()

  it 'returns true if page was reloaded', ->
    actual = z.util.is_same_location 'https://app.YAA.com', 'https://app.YAA.com'
    expect(actual).toBeTruthy()

  it 'returns true if page was reloaded with parameters', ->
    actual = z.util.is_same_location 'https://app.YAA.com/?hl=de', 'https://app.YAA.com/?hl=de'
    expect(actual).toBeTruthy()
...
describe 'z.util.safe_window_open', ->
  ...
  it 'add http if protocol is missing', ->
    ...
    new_window = window.open url
    expect(new_window.location).not.toBe 'http://YAA.com/'
