...
describe 'z.client.ClientMapper', ->
  mapper = new z.client.ClientMapper()
  ...
  describe 'map_client', ->
    ...
    it 'can map a temporary client payload from the backend', ->
      client_payload = entities.clients.john_doe.temporary
    ...
    it 'can map a remote client payload from the backend', ->
      client_payload = entities.clients.jane_roe.plain
  ...
  describe 'map_clients', ->
    it 'can map a multiple clients at once', ->
      client_ets = mapper.map_clients payload.clients.get.many
