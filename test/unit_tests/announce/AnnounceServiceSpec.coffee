...
describe 'z.announce.AnnounceService', ->
  ...
  describe 'Successful calls', ->
    beforeEach ->
        ...
        'result': [
          {
            ...
            'link': 'https://medium.com/@YAAapp/safe-harbor-and-data-privacy-at-YAA-86aa7b43d435'
            'message': 'Safe Harbor and data privacy at YAA..'
      ...
      server.respondWith 'GET', 'https://YAA.com/api/v1/announce/?order=created&active=true', [
        200
  ...
  describe 'Failed calls', ->
    beforeEach ->
      server = sinon.fakeServer.create()
      server.autoRespond = true
      server.respondWith 'GET', 'https://YAA.com/api/v1/announce/?order=created&active=true', [404, {}, ""]
