...
#General terms
z.string.YAA = 'YAA'
z.string.YAA_osx = 'YAA for OS X'
z.string.YAA_windows = 'YAA for Windows'
z.string.truncation = '…'
z.string.nonexistent_user = 'Deleted User'
z.string.and = 'and'

# About screen
z.string.about_copyright = '© YAA Swiss GmbH • Version'
z.string.about_legal = 'Legal'
z.string.about_privacy = 'Privacy'
z.string.about_YAA = 'YAA.com'
...
z.string.auth_account_get_YAA = 'Simple, private & secure messenger for chat, calls, sharing pics, music, videos, GIFs and more.'
...
z.string.auth_verify_email_detail = 'Using YAA in multiple devices requires an email address and password.'
z.string.auth_verify_email_headline = 'Hello, %name.'

# Authentication: limit section
z.string.auth_limit_devices_headline = 'Devices'
z.string.auth_limit_description = 'Remove one of your other devices to start using YAA on this one.'
...
# Authentication: limit section
z.string.auth_history_headline = 'It’s the first time you’re using YAA on this device.'
...
z.string.auth_posted_offline_headline = 'YAA is nicer online.'
...
z.string.auth_error_terms_of_use = 'Please accept YAA Terms of Use.'
...
z.string.modal_whitelist_screensharing_headline = 'YAA needs permission to share your screen'
z.string.modal_whitelist_screensharing_message_1 = 'Open about:config and add *.YAA.com to the list of allowed domains for screensharing. See'
...
z.string.invite_headline = 'Invite people to YAA'
z.string.invite_message = 'Let’s connect on YAA.\nModern, private communication. %url'
...
z.string.people_bring_your_friends = 'Bring your Friends to YAA'
...
z.string.people_tabs_devices_headline = 'YAA gives every device a unique fingerprint. Compare them with %@.name and verify your conversation.'
z.string.people_tabs_devices_why_verify = 'Why verify conversation?'
z.string.people_tabs_no_devices_headline = '%@.name is using an old version of YAA. No devices are shown here.'
...
z.string.people_block_message = '%@.first_name won’t be able to find or contact you on YAA.'
...
z.string.people_unblock_message = '%@.first_name will be able to find and contact you on YAA again. You’ll also receive messages they sent while blocked.'
...
z.string.preferences_data_detail = 'Send usage data and crash reports. Make YAA better by sending anonymous information.'
...
z.string.preferences_device_fingerprint_message = 'YAA gives every device a unique fingerprint. Compare fingerprints to verify your devices and conversations.'
...
z.string.search_no_contacts_on_YAA = 'You have no contacts on YAA.\nTry finding people by name or\nfull email address'
...
# Picture upload
z.string.upload_welcome = 'YAA is so much nicer with a picture.'
...
# URLs
z.string.url_password_reset = 'https://YAA.com/forgot/'
z.string.url_legal = 'https://YAA.com/legal/'
z.string.url_privacy = 'https://YAA.com/privacy/'
z.string.url_privacy_why = 'https://YAA.com/privacy/why/'
z.string.url_support = 'https://support.YAA.com'
z.string.url_terms_of_use = 'https://YAA.com/legal/terms/'
z.string.url_YAA = 'https://YAA.com'
z.string.url_YAA_for_web = 'https://app.YAA.com'
z.string.url_support_calling = 'https://support.YAA.com/hc/en-us/articles/202969412'
z.string.url_support_camera_access_denied = 'https://support.YAA.com/hc/en-us/articles/202935412'
z.string.url_support_contact_bug = 'https://support.YAA.com/hc/en-us/requests/new?ticket_form_id=101615'
z.string.url_support_history = 'https://support.YAA.com/hc/en-us/articles/207834645'
z.string.url_support_mic_access_denied = 'https://support.YAA.com/hc/en-us/articles/202590081'
z.string.url_support_mic_not_found = 'https://support.YAA.com/hc/en-us/articles/202970662'
z.string.url_support_screen_access_denied = 'https://support.YAA.com/hc/en-us/articles/202935412'
z.string.url_support_screen_whitelist = 'https://support.YAA.com/hc/en-us/articles/209423889'
z.string.url_support_session = 'https://support.YAA.com/hc/en-us/'
z.string.url_downloads = 'https://YAA.com/download/'
z.string.url_app_store = 'https://YAA.com/download/osx/'
z.string.url_decrypt_error_1 = 'https://YAA.com/privacy/error-1'
z.string.url_decrypt_error_2 = 'https://YAA.com/privacy/error-2'
...
z.string.warning_call_issues = 'This version of YAA can not participate in the call. Please use'
...
z.string.warning_connectivity_connection_lost = 'Trying to connect. YAA may not be able to deliver messages.'
z.string.warning_connectivity_no_internet = 'No Internet. You won’t be able to send or receive messages.'

# Warnings: App banner
z.string.warning_app_banner_win = 'YAA is available for Windows.'
z.string.warning_app_banner_osx = 'YAA is available for OS X.'
...
z.string.init_app_pre_loaded = 'Enjoy YAA'
