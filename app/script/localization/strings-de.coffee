...
#General terms
z.string.de.YAA = 'YAA'
z.string.de.YAA_osx = 'YAA für OS X'
z.string.de.YAA_windows = 'YAA für Windows'
z.string.de.truncation = '…'
z.string.de.nonexistent_user = 'Gelöschte Person'
z.string.de.and = 'und'

# About screen
z.string.de.about_copyright = '© YAA Swiss GmbH • Version'
z.string.de.about_legal = 'Datenschutz u. AGB'
z.string.de.about_privacy = 'Privatsphäre'
z.string.de.about_YAA = 'YAA.com'
...
z.string.de.auth_account_get_YAA = 'Ein moderner und sicherer Messenger für Unterhaltungen, Anrufe, Bilder, Musik, Videos, GIFs und mehr.'
...
z.string.de.auth_verify_email_detail = 'Um YAA auf mehreren Geräten benutzen zu können, werden eine E-Mail-Adresse und Passwort benötigt.'
...
z.string.de.auth_limit_description = 'Entferne eines deiner anderen Geräte, um YAA hier zu nutzen.'
...
# Authentication: limit section
z.string.de.auth_history_headline = 'Du benutzt YAA zum ersten Mal auf diesem Gerät.'
...
z.string.de.auth_posted_offline_headline = 'YAA ist online schöner.'
...
z.string.de.modal_block_conversation_message = '%@.name wird dich auf YAA nicht finden können.'
...
z.string.de.modal_whitelist_screensharing_headline = 'YAA braucht die Berechtigung deinen Bildschirm zu teilen'
z.string.de.modal_whitelist_screensharing_message_1 = 'Öffne about:config und füge *.YAA.com zur Liste der für Screensharing zugelassenen Domains hinzu. Lies den'
...
z.string.de.invite_headline = 'Lade Freunde zu YAA ein'
z.string.de.invite_message = 'Füge mich auf YAA als Kontakt hinzu.\nModerne, private Kommunikation. %url'
...
z.string.de.people_bring_your_friends = 'Hole deine Freunde zu YAA'
...
z.string.de.people_tabs_devices_headline = 'YAA gibt jedem Gerät einen einzigartigen Fingerabdruck. Vergleiche diese mit %@.name und überprüfe deine Unterhaltung.'
z.string.de.people_tabs_devices_why_verify = 'Warum sollte ich meine Unterhaltungen verifizieren?'
z.string.de.people_tabs_no_devices_headline = '%@.name benutzt eine ältere Version von YAA. Es werden keine Geräte angezeigt.'
...
z.string.de.people_block_message = '%@.first_name wird dich auf YAA nicht finden können.'
...
z.string.de.people_unblock_message = '%@.first_name wird dich über YAA wieder finden und kontaktieren können. Du empfängst alle Nachrichten die verschickt wurden, während der Kontakt blockiert war.'
...
z.string.de.preferences_data_detail = 'Sende uns Fehler- und Nutzungsberichte. Hilf uns YAA durch das Senden anonymisierter Informationen zu verbessern.'
...
z.string.de.preferences_device_fingerprint_message = 'YAA gibt jedem Gerät einen einzigartigen Fingerabdruck. Vergleiche die Fingerabdrücke zur Verifizierung deiner Geräte und Unterhaltungen.'
...
z.string.de.search_no_contacts_on_YAA = 'Du hast keine Kontakte auf YAA.\nSuch nach Namen oder vollständigen\nE-Mail-Adressen'
...
# Picture upload
z.string.de.upload_welcome = 'YAA ist so viel schöner mit einem Bild.'
...
# URLs
z.string.de.url_password_reset = 'https://YAA.com/forgot/?hl=de'
z.string.de.url_legal = 'https://YAA.com/legal/?hl=de'
z.string.de.url_privacy = 'https://YAA.com/privacy/?hl=de'
z.string.de.url_privacy_why = 'https://YAA.com/privacy/why/'
z.string.de.url_support = 'https://support.YAA.com/hc/de'
z.string.de.url_terms_of_use = 'https://YAA.com/legal/terms/'
z.string.de.url_YAA = 'https://YAA.com/?hl=de'
z.string.de.url_YAA_for_web = 'https://app.YAA.com'
z.string.de.url_support_calling = 'https://support.YAA.com/hc/de/articles/202969412'
z.string.de.url_support_camera_access_denied = 'https://support.YAA.com/hc/de/articles/202935412'
z.string.de.url_support_contact_bug = 'https://support.YAA.com/hc/de/requests/new?ticket_form_id=101615'
z.string.de.url_support_history = 'https://support.YAA.com/hc/de/articles/207834645'
z.string.de.url_support_mic_access_denied = 'https://support.YAA.com/hc/de/articles/202590081'
z.string.de.url_support_mic_not_found = 'https://support.YAA.com/hc/de/articles/202970662'
z.string.de.url_support_screen_access_denied = 'https://support.YAA.com/hc/de/articles/202935412'
z.string.de.url_support_screen_whitelist = 'https://support.YAA.com/hc/de/articles/209423889'
z.string.de.url_support_session = 'https://support.YAA.com/hc/de'
z.string.de.url_downloads = 'https://YAA.com/download/?hl=de'
z.string.de.url_app_store = 'https://YAA.com/download/osx/'
z.string.de.url_decrypt_error_1 = 'https://YAA.com/privacy/error-1/?hl=de'
z.string.de.url_decrypt_error_2 = 'https://YAA.com/privacy/error-2/?hl=de'
...
z.string.de.warning_call_issues = 'Diese Version von YAA kann nicht an Anrufen teilnehmen. Nutze'
...
z.string.de.warning_connectivity_connection_lost = 'Verbindung wird wiederhergestellt. YAA kann Nachrichten möglicherweise nicht empfangen.'
z.string.de.warning_connectivity_no_internet = 'Keine Internetverbindung. Du kannst keine Nachrichten senden und empfangen.'

# Warnings: App banner
z.string.de.warning_app_banner_win = 'YAA ist für Windows verfügbar.'
z.string.de.warning_app_banner_osx = 'YAA ist für OS X verfügbar.'
...
z.string.de.init_app_pre_loaded = 'Viel Spaß mit YAA'
