...
class z.main.App
  ...
  _setup_view_models: ->
    ...
    view.main                      = new z.ViewModel.MainViewModel 'YAA-main', @repository.user
  ...
  _show_ui: ->
    ...
    if conversation_et and has_picture
      ...
      # Triggered when newly registered user opens YAA (first run experience)
...
###############################################################################
$ ->
  if $('#YAA-main-app').length isnt 0
    YAA.app = new z.main.App YAA.auth
