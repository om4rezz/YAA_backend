...
class z.assets.AssetRemoteData
  ...
  @v3: (asset_key, otr_key, sha256, asset_token) ->
    ...
    remote_data.generate_url = -> YAA.app.service.asset.generate_asset_url_v3 asset_key, asset_token
    return remote_data
  ...
  @v2: (conversation_id, asset_id, otr_key, sha256) ->
    remote_data = new z.assets.AssetRemoteData otr_key, sha256
    remote_data.generate_url = -> YAA.app.service.asset.generate_asset_url_v2 asset_id, conversation_id
    return remote_data
