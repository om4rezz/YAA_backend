...
class z.components.UserProfileViewModel
  constructor: (params, component_info) ->
    ...
    @client_repository = YAA.app.repository.client
    @conversation_repository = YAA.app.repository.conversation
    @cryptography_repository = YAA.app.repository.cryptography
    @user_repository = YAA.app.repository.user
