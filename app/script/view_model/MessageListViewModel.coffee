...
class z.ViewModel.MessageListViewModel
  ...
  on_message_user_click: (user_et, element) =>
    ...
    create_bubble = (element_id) =>
      YAA.app.view.content.participants.reset_view()
    ...
    show_bubble = =>
      YAA.app.view.content.participants.confirm_dialog?.destroy()
      ...
      if @participant_bubble or YAA.app.view.content.participants.participants_bubble?.is_visible()
