...
def user_agent():
  ...
  if agent == 'ipad':
    ...
    user_agent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_3) AppleWebKit/537.36 (KHTML, like Gecko) YAA/2.6.2587 Chrome/49.0.2623.75 Electron/0.37.2 Safari/537.36'
...
def get_url():
  ...
  if 'app.YAA.com' in host:
    host = 'app.YAA.com'
  elif 'next' in host:
    host = 'YAA-webapp-prod-next.YAA.com'
  elif 'staging' in host:
    host = 'YAA-webapp-staging.zinfra.io'
  elif 'edge' in host:
    host = 'YAA-webapp-edge.zinfra.io'
